    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          <h2>
            Welcome to <span>Pluto</span> Tech Community
          </h2>
          <p>
            The vast community of passionate designers and developers who are
            determined to change the world, one line of code at a time.
          </p>
            ...
            <div className="row gy-4">
              <div className="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
                <div className="service-item position-relative">
                  ...
                  <h4>
                    <a className="stretched-link">Research</a>
                  </h4>
              ...
              >
                <div className="service-item position-relative">
                  ...
                  <h4>
                    <a className="stretched-link">Plan</a>
                  </h4>
                  <p>
                    We divide us into teams and plan the course of our action.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="service-item position-relative">
                  ...
                  <h4>
                    <a className="stretched-link">Code</a>
                  </h4>
                  <p>
                    We implement most reliable tech-stack for creation of a
                    solution.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="service-item position-relative">
                  ...
                  <p>
                    After months of intense work we launch our project for
                    benefit of humanity.
                  </p>
                </div>
              </div>
          ...
          <div className="container" data-aos="zoom-out">
            <div className="row g-5">
              <div className="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
                <h3>
                  There are a lot of <em>Important</em> problems that are
                  waiting to be solved.
                </h3>
                <p>
                  We encourage our community members, supporters and common
                  people to inform us of any such 'Important Problems' in their
                  nearby world. Not only we will try our 100% to solve the
                  problem but also gives the reporter credits and FREE Swags!
                </p>
                <Link to="/report-a-problem">
                  <a className="cta-btn align-self-start" href="#">
                    Report an Important Problem
                  </a>
                </Link>
              </div>
          ...
          <div className="container-fluid p-0" data-aos="fade-up">
            <div className="row g-0">
              <div className="col-lg-6 video-play position-relative">
                <a
                  href="https://youtu.be/eCCKH6qYLKo"
              ...
              <div className="col-lg-6">
                <div className="content d-flex flex-column justify-content-center h-100">
                  ...
                  <p className="fst-italic">
                    We are a closely coupled community, meaning we work with
                    each other very closely. We film the fun aspects of our jobs
                    and wishes you to see them too! But before, here are some
                    stuff we abide to at our community.
                  </p>
                  <ul>
                    <li>
                      <i className="bi bi-check-circle"></i> Independence
                      interms of creativity and innovation.
                    </li>
                    <li>
                      <i className="bi bi-check-circle"></i> No honourary
                      salutations. No Sir/ma'am. Just say our names!
                    </li>
                    <li>
                      <i className="bi bi-check-circle"></i> Work + Fun = Job
                      Completed!
                    </li>
                  </ul>
              ...
              <div className="tab-pane active show" id="tab-1">
                <div className="row gy-4">
                  ...
                  >
                    <h3>Data Science</h3>
                    <p className="fst-italic">
                      We use advanced data analytics techniques to discover
                      hidden meanings behind a given set of data, which can be
                      hosted open source at sources like{" "}
                      <a href="https://www.kaggle.com/">Kaggle.com</a> for ML
                      engineers make solutions for the solution.
                    </p>
                    <ul>
                      <li>
                        <i className="bi bi-check-circle-fill"></i> Hottest
                        problems to work on.
                      </li>
                      <li>
                        <i className="bi bi-check-circle-fill"></i> Total work
                        credit and exposure.
                      </li>
                      <li>
                        <i className="bi bi-check-circle-fill"></i> Learn by
                        solving real-life problems and challenges.
                      </li>
                    </ul>
                    <p>
            ...
            <div className="row gy-4">
              <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                <div className="content px-xl-5">
                  ...
                  <p>
                    At neuron, we cherish the art of questioning. Gift us with
                    your curiosity and we shall repay it through answers.
                  </p>
                </div>
